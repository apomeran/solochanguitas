...
$data["estado"] = "ok";
$data["html"] = "<button class='btn btn-link' id='btn-changuitas-barrios-todos'>Todos</button> | <button class='btn btn-link' id='btn-changuitas-barrios-ninguno'>Ninguno</button><button class='btn btn-link'>Cerrar</button>";
