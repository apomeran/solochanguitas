...
<?php
    ...
    $f = new Funciones();
    $sql = "select p.pregunta, u.nombre, u.apellido, p.pregunta_fecha from preguntas as p left join usuarios as u on p.usuario = u.id where p.id = $id and p.activo = '1'";
    $res = $bd->query($sql);
    $fila = $res->fetch_assoc();
?>
<div class="row">
    <div class="span12">
        <form class="form-horizontal" id="editar-pregunta">
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea id="pregunta" name="pregunta" class="span5"><?php echo $fila["pregunta"] ?></textarea>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">Usuario</label>
                    <div class="controls">
                        <input type="text" value="<?php echo $fila["nombre"]." ".$fila["apellido"] ?>" class="span5" disabled readonly />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">Fecha</label>
                    <div class="controls">
                        <input type="text" value="<?php echo $f->convertirMuestra($fila["pregunta_fecha"], "fecha") ?>" class="span5" disabled readonly />
                    </div>
                </div>
